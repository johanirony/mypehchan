...
const STEPS=[
    {
        ...
        description:"Choose an Image for your customization.",
        url:'/upload'
    },
    {
...
export default function Steps() {
  ...
  return (
    <ol className='rounded-md bg-white lg:flex lg:rounded-none lg:border-r lg:border-gray-200'>{STEPS.map((step,i)=>{
            ...
            <div className="">
                ...
                'flex items-center px-6 py-4 text-sm font-medium ' )}>
                    <span className='flex-shrink-0' >
                        <img src={imgPath} className={cn("flex h-5 w-5 object-contain items-center justify-center",{
